...
./server_script.sh 56
./irq_dmr.sh 0 16
./scaling.sh ping "cbb_scaling_Core_0-55_CCB0_irq_combined_20_local_pipe_1_size_64" 56 

./core_manage.sh offline 0 223
./core_manage.sh online 0 111
ethtool -L ens3np0 combined 28
...
ethtool -L ens3np0 combined 56
./server_script.sh 224
./irq_dmr.sh "0 1 2 3" 14
